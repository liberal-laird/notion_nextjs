...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '21c8e5e8dc6545f79c6a4bcb65ebf612',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'cuper_eth', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个币圈小混子🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://feedscoin.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'WLFI, Archlinux, 博客', // 网站关键词 英文逗号隔开
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-4522670236044605', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '4484459277', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
  ADSENSE_GOOGLE_SLOT_FLOW: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '9910955433', // Google AdScene>广告>按单元广告>新建信息流广告
